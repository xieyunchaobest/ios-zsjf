...
@interface GcztxxtjViewController ()

@end

@implementation GcztxxtjViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"工程在途信息" date:date];
...
-(void)requestData{
    ...
    NSString* subUrl=[[[NSString alloc] initWithString:@"/tm/ZSJFAction.do?method=showGCZTTJReport"] autorelease];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellTableIndentifier = @"CellTableIndentifiergczt";
    UINib *nib = [UINib nibWithNibName:@"gcztCell" bundle:nil];
    [tableView registerNib:nib forCellReuseIdentifier:CellTableIndentifier];
    gcztCell *cell = [tableView dequeueReusableCellWithIdentifier:CellTableIndentifier];
    ...
    [cell.lbldqhj setText:[md objectForKey:@"dqhj"]];
