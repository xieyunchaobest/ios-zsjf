...
@interface HSYB4GJZB4KDViewController ()

@end

@implementation HSYB4GJZB4KDViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"宽带关键指标" date:date];
        ...
        if([reportFlag isEqualToString:@"dyfz"]){
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"kdDyfzDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"kdDyfzSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"kdDyfzZzs"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"kdDyfzZzl"];
                }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"kdCzsrDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"kdCzsrSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"kdCzsrHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"kdCzsrTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"kdCzsrDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"kdCzyhsDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"kdCzyhsSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"kdCzyhsHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"kdCzyhsTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"kdCzyhsDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
        }
...
- (IBAction)chooseDate:(UIDatePicker*)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
        [super setWrapTitle:@"宽带关键指标" date:selectDate];
        NSLog(@"selectDateselectDate%@",selectDate);
