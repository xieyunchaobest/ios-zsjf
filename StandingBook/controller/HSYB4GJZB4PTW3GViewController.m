...
@interface HSYB4GJZB4PTW3GViewController ()

@end

@implementation HSYB4GJZB4PTW3GViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"普通网3G关键指标" date:date];
        ...
        if([reportFlag isEqualToString:@"dyfz"]){
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt3gDyfzDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt3gDyfzSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt3gDyfzZzs"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt3gDyfzZzl"];
                }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt3gCzsrDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt3gCzsrSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt3gCzsrHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt3gCzsrTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"pt3gCzsrDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt3gCzyhsDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt3gCzyhsSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt3gCzyhsHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt3gCzyhsTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"pt3gCzyhsDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
        }
...
- (IBAction)chooseDate:(UIDatePicker*)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
        NSLog(@"selectDateselectDate%@",selectDate);
        [super setWrapTitle:@"普通网3G关键指标" date:selectDate];
