...
@interface HSYB4GJZB4OCS3GViewController ()

@end

@implementation HSYB4GJZB4OCS3GViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"OCS3G关键指标" date:date];
        ...
        if([reportFlag isEqualToString:@"dyfz"]){
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"ocs3gDyfzDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"ocs4gDyfzSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"ocs5gDyfzZzs"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"ocs6gDyfzZzl"];
                }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"ocs7gCzsrDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"ocs8gCzsrSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"ocs9gCzsrHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"ocs10gCzsrTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"ocs11gCzsrDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"ocs12gCzyhsDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"ocs13gCzyhsSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"ocs14gCzyhsHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"ocs15gCzyhsTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"ocs16gCzyhsDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
        }
...
- (IBAction)chooseDate:(UIDatePicker*)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
        NSLog(@"selectDateselectDate%@",selectDate);
        [super setWrapTitle:@"OCS3G关键指标" date:selectDate];
