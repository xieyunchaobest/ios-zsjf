...
@interface HSRB42g3grhViewController ()

@end

@implementation HSRB42g3grhViewController
...
- (void)viewDidLoad
{
   ...
   // self.title=@"2G3G融合日报";
    ...
    [super setWrapTitle:@"2G3G融合日报" date:date];
...
-(void)initData:(NSMutableDictionary*) requestDic {
    ...
    NSString* subUrl=[[[NSString alloc] initWithString:@"tm/ZSJFAction.do?method=hsrb42g3grh"] autorelease];
...
- (IBAction)chooseDate:(UIDatePicker*)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
        [super setWrapTitle:@"2G3G融合日报" date:selectDate];
        NSLog(@"selectDateselectDate%@",selectDate);
