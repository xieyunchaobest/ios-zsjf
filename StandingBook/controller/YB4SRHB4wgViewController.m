...
@interface YB4SRHB4wgViewController ()

@end

@implementation YB4SRHB4wgViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"网格收入环比通报" date:date];
...
-(void)initData:(NSMutableDictionary*)requestDic{
    ...
    NSString* subUrl=@"";
    subUrl=[[[NSString alloc] initWithString:@"tm/ZSJFAction.do?method=showYB4srhbtb4wg"] autorelease];
//    NSMutableDictionary* requestData = [[NSMutableDictionary alloc] init];
//    [_reqdic setObject:adate forKey:@"date"];
...
- (IBAction)chooseDate:(id)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
         [super setWrapTitle:@"网格收入环比通报" date:[selectDate substringWithRange:NSMakeRange(0,7)]];
