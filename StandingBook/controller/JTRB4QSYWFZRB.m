...
@interface JTRB4QSYWFZRB ()

@end

@implementation JTRB4QSYWFZRB
...
-(void)initData:(NSMutableDictionary*) requestDic {
    ...
    NSString* subUrl=[[[NSString alloc] initWithString:@"tm/ZSJFAction.do?method=jtrb4qsjywfzrb"] autorelease];
    ...
    for (int i = 0; i < [array  count]; i ++) {//行数
        ...
        for (NSString *key in trDict) {
            ...
            if([key isEqualToString:@"0"]){
                ...
                rfa=[vo objectForKey:@"qgs"];
            }else if([key isEqualToString:@"2"]){
                rfa=[vo objectForKey:@"fgs"];
            }
