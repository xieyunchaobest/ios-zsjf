...
@interface HSYB4GJZB4PTW2GViewController ()

@end

@implementation HSYB4GJZB4PTW2GViewController
...
- (void)viewDidLoad
{
    ...
    [super setWrapTitle:@"普通网2G关键指标" date:date];
        ...
        if([reportFlag isEqualToString:@"dyfz"]){
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt2gDyfzDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt2gDyfzSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt2gDyfzZzs"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt2gDyfzZzl"];
                }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt2gCzsrDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt2gCzsrSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt2gCzsrHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt2gCzsrTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"pt2gCzsrDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
            ...
            for (NSString *key in trDict) {
                ...
                if([key isEqualToString:@"0"]){
                    ...
                    rfa=[vo objectForKey:@"pt2gCzyhsDy"];
                }else if([key isEqualToString:@"2"]){
                    rfa=[vo objectForKey:@"pt2gCzyhsSy"];
                }else if([key isEqualToString:@"3"]){
                    rfa=[vo objectForKey:@"pt2gCzyhsHbzzl"];
                }else if([key isEqualToString:@"4"]){
                    rfa=[vo objectForKey:@"pt2gCzyhsTbzzl"];
                }else if([key isEqualToString:@"5"]){
                    rfa=[vo objectForKey:@"pt2gCzyhsDbzzl"];
                }
                [data setValue:rfa forKey:key];
            }
        }
...
- (IBAction)chooseDate:(UIDatePicker*)sender {
    ...
    if (self.myDatePicker.datePickerMode == UIDatePickerModeTime) {
        ...
        NSString *selectDate =  [dateFormatter stringFromDate:select];
        [super setWrapTitle:@"普通网2G关键指标" date:selectDate];
        NSLog(@"selectDateselectDate%@",selectDate);
