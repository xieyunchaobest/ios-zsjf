...
- (instancetype)initWithItems:(NSArray *)items {
    if ((self = [super init])) {
        _itemSize = CGSizeMake(80.f, 60.f);
        _cornerRadius = 8.f;
...
//        _backgroundColor = [UIColor colorWithRed:250 green:226 blue:152 alpha:1];
        _backgroundColor = [UIColor colorWithRed:234.0f/255.0f green:245.0f/255.0f blue:255.0f/255.0f alpha:1];
        _bounces = YES;
...
- (void)selectItemViewAtPoint:(CGPoint)point {
    ...
    if (![item isEmpty]) {
        selectedItemView.backgroundColor = [UIColor blueColor];
